...
const services = [
  { icon: Home, title: "Real Estate Brokerage", description: "Residential and commercial buying and selling with dedicated agents who know Winnipeg's market.", href: "/brokerage", accent: "Buy · Sell · Invest" },
  { icon: Building2, title: "Property Management", description: "Full-service residential and commercial property management. From leasing to maintenance to reporting.", href: "/property-management", accent: "Residential · Commercial" },
  { icon: TrendingUp, title: "Investments & Development", description: "Joint ventures, multifamily opportunities, and development projects through the Barso Group.", href: "/investments", accent: "Joint Ventures · Development" },
  { icon: Users, title: "Join Chapter", description: "Elevate your real estate career with industry-leading commission structures, tools, and support.", href: "/recruitment", accent: "Agents · Brokers" },
];
    ...
    <section className="py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-100">
          {services.map(({ icon: Icon, title, description, href, accent }, i) => (
            <motion.div
              key={title}
