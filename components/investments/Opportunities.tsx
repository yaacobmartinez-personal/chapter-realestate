        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-24">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-light text-black leading-tight mb-6">
              Invest With<br /><span className="font-serif italic">Confidence</span>
            </h2>
            <p className="text-gray-500 font-light leading-relaxed text-sm max-w-sm">
              Chapter&apos;s investment division connects qualified investors with curated real estate opportunities — from income-producing multifamily assets to ground-up development projects.
            </p>
          </motion.div>
          <div className="grid grid-cols-2 gap-4">
            {investmentStats.map(({ number, label }, i) => (
              <motion.div
                key={label}
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className={`text-xs tracking-widest uppercase font-light px-3 py-1 ${tag === "Active" ? "bg-black text-white" : "border border-gray-200 text-gray-400"}`}>
                    {tag}
                  </span>
                </div>
