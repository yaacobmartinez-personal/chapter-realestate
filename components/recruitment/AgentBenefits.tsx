...
const benefits = [
  ...
  "Regular training & market education",
  "Flexible office & co-working access",
  "Referral network across all divisions",
];
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-light text-black leading-tight mb-8">
              Everything You
              <br />
              <span className="font-serif italic">Need to Succeed</span>
            </h2>
            <div className="divide-y divide-gray-100">
              {benefits.map((b, i) => (
                ...
                >
                  <CheckCircle size={14} className="text-[#c8a96e] shrink-0" />
                  {b}
                </motion.div>
              ))}
            </div>
